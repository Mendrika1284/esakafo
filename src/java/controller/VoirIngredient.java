 ...
 * @author Jupiter
 */
public class VoirIngredient extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Ingredient[] ingredient = si.voirIngredientPlatDAO(idPlat);
            
            request.setAttribute("listeIngredient", ingredient);
            
            RequestDispatcher view = request.getRequestDispatcher("voirIngredient.jsp");
            view.forward(request, response);
        } catch (Exception ex) {
            Logger.getLogger(VoirIngredient.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
