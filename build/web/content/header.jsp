	...
	<div class="top-bar">
		<div class="container">
			...
			<div class="tb-contact pull-left">
				<!-- Email -->
				<i class="fa fa-envelope color"></i> &nbsp; <a href="mailto:contact@esakafo.com">contact@esakafo.com</a>
				&nbsp;&nbsp;
				<!-- Phone -->
				<i class="fa fa-phone color"></i> &nbsp; +261 34 52 098 60
			</div>
			<!-- Contact ends -->
		...
		<div class="navi">
			<div class="container">
				<div class="navy">
					<ul>
						<!-- Main menu -->
						<li><a href="ListePlat">Accueil</a></li>
                                                <li><a href="VoirPourboire"><span>Voir Pourboire</span></a></li>
                                                <li><a href="AffichageCommanderPlat"><span>Commander Plat</span></a></li>
                                                <li><a href="ConsommationIngredient"><span>Consommation Ingredient</span></a></li>
                                                <li><a href="Stock"><span>Stock</span></a></li>
                                                <li><a href="ListePayement.jsp"><span>Voir Paiement</span></a></li>
		<!-- Navigation ends -->
