            ...
            for(int i = 0; i < listeIngredient.length; i++){ %>
                <tr>
                  <td style="font-family:cursive;font-size: 15px"><center><%= listeIngredient[i].getId() %></center></td>
                   ...
                   <% if(listeIngredient[i].getQuantiteIngredient() <= 5){ %>
                    <td style="font-family:cursive;font-size: 15px;background-color:red; color: white" ><center><%= listeIngredient[i].getQuantiteIngredient() %></center></td>
                    <% }else{ %>
                    <td style="font-family:cursive;font-size: 15px;color:black" ><center><%= listeIngredient[i].getQuantiteIngredient() %></center></td>
                    <% } %>
                </tr>                         
          </tbody>
        <% }} %>   
