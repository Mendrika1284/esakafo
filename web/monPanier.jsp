		...
		<div class="shopping-content">
			...
			<% for(int i = 0; i < listeDetailCommande.length; i++){ %>
					...
					<div class="shopping-item">
						<!-- Image -->
						<a href="single-product.html"><img class="img-responsive"  src="img/plat/<%= listeDetailCommande[i].getNomPlat() %>.jpg" alt="" /></a>
						...
						<div class="clearfix"></div>
                                                  ...
                                                  <%  }%>
                                <br>
                                <% Integer idCommande = (Integer) request.getAttribute("idCommande"); %>
                                <center><a href="ExportPDF?idCommande=<%= idCommande %>" >Recevoir ma facture</a></center>
			</div>
			<!-- Pagination -->
			...
			<div class="col-md-3 col-sm-6">
					<%int total = 0;%>
                                         ...
                                         <% int PrixPlat =listeDetailCommande[i].getPrix()* listeDetailCommande[i].getQuantite() ; 
                                         total += PrixPlat;%>
                                        <!-- Shopping items -->
					<%}%>
                                        
                                          <h2 style = "font-family: fantasy;margin-top:400px">Prix total = <%=total %> AR </h2>
				</div>
			<!-- Pagination end-->
		</div>
	</div>
