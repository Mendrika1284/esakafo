	...
	<div class="container">
		...
		<div class="shopping-content">
			...
			<div class="block-heading-two">
				<h3><span>INSERTION COMMANDE</span></h3>
			</div>
...
<h4 style="font-family:cursive;width:200px;" > SERVEUR :</h4>
...
<h4 style="font-family:cursive;width:200px;">TABLE :</h4>
<input type="number" style="font-family:cursive;width:200px;" name="table" min="1" max="10" class="form-control">
<br>
